...
TRUNCATE public.cl_humidity_09hours;

-- Insert data
INSERT INTO public.cl_humidity_09hours(
...
FROM public.humidity_09hours_raw AS hum

JOIN public.cl_stations AS st
ON	hum."STN_ID" = st.station_id

JOIN public.cl_rcp AS rcp
ON	UPPER(hum."RCP")  = rcp.rcp_id

JOIN public.cl_models AS MO
...
-- Delete data before inserting
TRUNCATE public.cl_humidity_15hours;

-- Insert data
INSERT INTO public.cl_humidity_15hours(
	station_id, rcp_id, model_id, climatology_year, 
	annual, djf, mam, jja, son, ndjfma, mjjaso, 
	january, february, march, april, may, june, 
	july, august, september, october, november, december)
...
FROM public.humidity_15hours_raw AS hum
...
-- Delete data before inserting
TRUNCATE public.cl_maximum_temperatures;

-- Insert data
INSERT INTO public.cl_maximum_temperatures(
	station_id, rcp_id, model_id, climatology_year, 
	annual, djf, mam, jja, son, ndjfma, mjjaso, 
	january, february, march, april, may, june, 
	july, august, september, october, november, december)
...
FROM public.maximum_temperatures_raw AS tm
...
-- Delete data before inserting
TRUNCATE public.cl_mean_temperatures;

-- Insert data
INSERT INTO public.cl_mean_temperatures(
	station_id, rcp_id, model_id, climatology_year, 
	annual, djf, mam, jja, son, ndjfma, mjjaso, 
	january, february, march, april, may, june, 
	july, august, september, october, november, december)
...
FROM public.mean_temperatures_raw AS tm
...
-- Delete data before inserting
TRUNCATE public.cl_minimum_temperatures;

-- Insert data
INSERT INTO public.cl_minimum_temperatures(
	station_id, rcp_id, model_id, climatology_year, 
	annual, djf, mam, jja, son, ndjfma, mjjaso, 
	january, february, march, april, may, june, 
	july, august, september, october, november, december)
...
FROM public.minimum_temperatures_raw AS tm
...
-- Delete data before inserting
TRUNCATE public.cl_fire_projection_summary;

-- Insert data
INSERT INTO public.cl_fire_projection_summary(
	station_id, rcp_id, model_id, climatology_year, 
...
FROM public.nrm_fire_projection_summary_raw AS nrm
